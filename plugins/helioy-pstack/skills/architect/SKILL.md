...
Read [`../poteto-mode/references/helioy-runtime.md`](../poteto-mode/references/helioy-runtime.md) before parallel design exploration. Use the adapter's Arena contract for multiple shapes.
...
Run one runner each on `claude`, `codex`, `grok-fast`, `claude-opus`.
