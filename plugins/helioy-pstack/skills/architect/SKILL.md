...
Read [`../poteto-mode/references/helioy-runtime.md`](../poteto-mode/references/helioy-runtime.md) before parallel design exploration. Use a warroom Bakeoff for multiple shapes.
