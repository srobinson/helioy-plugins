...
Read [`../poteto-mode/references/helioy-runtime.md`](../poteto-mode/references/helioy-runtime.md) before delegation. Translate the resulting bespoke playbook into warroom phase contracts when it requires parallel agents.
