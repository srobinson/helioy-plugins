...
4. Write the resume note off-context. Capture intent, what you were doing, progress and what's verified, current state, next steps, key files, and gotchas. Choose a persistent session path via [`mdx-artifacts`](../../mdx-artifacts/SKILL.md), because the in-context plan won't survive summarization. If a show-me-your-work trail exists, point at it instead of duplicating it.
