...
Read [`../poteto-mode/references/helioy-runtime.md`](../poteto-mode/references/helioy-runtime.md) before source fanout. Use only relevant available sources and record null searches with their access limits.
...
Before spawning investigators, list the MCP servers available in this session from the tool list. Use the available-tools map when present.
