...
Every serious project needs a scripted way to drive the real app and prove behavior: launch it, exercise a feature the way a user would, and capture evidence. This skill generates that as a shared project skill (`.agents/skills/verify-<app>/`) tailored to the repo. Claude and Codex should reference this one body rather than maintain runtime-specific copies.
