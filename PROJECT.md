...
helioy-plugins/
  ...
  plugins/
    ...
    helioy-nancy-pm/    # Nancy PM role: planning, Linear workflow
    helioy-nancy-eng/   # Nancy engineering role: worker tools, handover
```

### Plugin: helioy-tools

The primary plugin. Six MCP servers, nine skills, thirteen agent definitions, and lifecycle hooks.
...
- `helioy-nancy-pm`: PM role — planning, Linear workflow, interactive task creation
